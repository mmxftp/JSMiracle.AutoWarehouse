...
{
    public class IMS_UP_MoFn_Dal : DataLayer<IMS_UP_MoFn>, IModuleFunction
    {
        //private IMS_UP_MoFn Update(IMS_UP_MoFn entity)
        //{
        //    IMS_UP_MoFn ent = null;
        //    if (entity.ID == 0)
        //    {
        ...
        //    else
        //    {
        //        ent = IMS_UP_MoFnT.Find(entity.ID);
        //        if (ent != null)
        //        {
        ...
        public IList<IMS_UP_MoFn> GetModuleFunctionList(int moduleid)
        {
            var data = this.DbContext.IMS_UP_MoFnT.Where(n => n.ModuleID == moduleid);
            return data.ToList();
        }

        //public IMS_UP_MoFn GetEntity(int id)
        //{
        //    return IMS_UP_MoFnT.Find(id);
        //}

        public override void SaveOrUpdate(IMS_UP_MoFn entity)
        {
            if (entity.FunctionID == 0)
            {
                ...
                var nextFunctionIDQueryable =
                    from a in this.DbContext.IMS_UP_MoFnT.Where(n => n.ModuleID == entity.ModuleID)
                    join b in this.DbContext.IMS_UP_MoFnT.Where(n => n.ModuleID == entity.ModuleID)
